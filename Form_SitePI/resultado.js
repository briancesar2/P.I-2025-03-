...
if (nivel) {
    document.getElementById("nivelExercicio").textContent = nome + ", seu nível é: " + nivel;
} else {
    document.getElementById("nivelExercicio").textContent = "Não foi possível calcular seu nível.";
}
...
if (dados.peso && dados.altura) {
    ...
    if (altura > 0) {
        ...
        if (imc >= 18.5 && imc <= 24.9) {
            ...
            feedbackLista.innerHTML += "<li>Seu IMC indica sobrepeso leve, importante cuidado com intensidade.</li>";
        } else {
